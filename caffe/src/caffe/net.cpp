...
void Net<Dtype>::Init(const NetParameter& in_param) {
  ...
  memory_used_ = 0;
  // set the input blobs
  //std::cout << "Ze param.input_size is test test" << param.input_size() << std::endl;
  for (int input_id = 0; input_id < param.input_size(); ++input_id) {
    //std::cout << "Ze never goes in this loop!" << std::endl;
  ...
  for (int layer_id = 0; layer_id < param.layer_size(); ++layer_id) {
    ...
    /*LOG(INFO) << "Current layer number is " << layer_id;
    ...
    //std::cout << "Ze param.bottom_size is " << layer_param.bottom_size() << std::endl;
    ...
    //std::cout << "Ze param.top_size is " << layer_param.top_size() << std::endl;
    ...
    //std::cout << "Setting up " << layer_names_[layer_id] << std::endl;

/*    std::cout << "Ze blob size is " << layers_[layer_id]->blobs().size() << std:: endl;
    ...
    std::cout << "    [Ze] "
       ...
       << " data: " << data_abs_val_mean << std::endl;
    }*/
    ...
    const Dtype data_abs_val_mean = blob.asum_data() / blob.count();
    std::cout << "    [Ze] "
       << "Layer " << layer_names_[layer_id] << " data: " << data_abs_val_mean << std::endl;
    }*/
...
Dtype Net<Dtype>::ForwardFromTo(int start, int end) {
  ...
  //std::cout << "layer_.size() is " << layers_.size() << std::endl;
  ...
  for (int i = start; i <= end; ++i) {
    ...
    clock_t begin_layer_time = std::clock();
    ...
    loss += layer_loss;
    clock_t end_layer_time = std::clock();
    double elapsed_layer_secs = double(end_layer_time - begin_layer_time) / CLOCKS_PER_SEC;
    std::cout << "Forward Time in " << layer_names_[i]  << " is " << elapsed_layer_secs << std::endl;
  ...
  //std::cout << "Forward Time: " << elapsed_secs << std::endl;
...
const vector<Blob<Dtype>*>& Net<Dtype>::ForwardPrefilled(Dtype* loss) {
  if (loss != NULL) {
    //std::cout << "loss is a null pointer!" <<std::endl;
    *loss = ForwardFromTo(0, layers_.size() - 1);
  } else {
    //std::cout << "loss is NOT a null pointer!" <<std::endl;
...
const vector<Blob<Dtype>*>& Net<Dtype>::Forward(
  ...
  //std::cout << "bottom.size() is " << bottom.size() << std::endl;
...
void Net<Dtype>::BackwardFromTo(int start, int end) {
  ...
  for (int i = start; i >= end; --i) {
    ...
    clock_t end_layer_time = std::clock();
    double elapsed_layer_secs = double(end_layer_time - begin_layer_time) / CLOCKS_PER_SEC;
    std::cout << "Backward Time in " << layer_names_[i]  << " is " << elapsed_layer_secs << std::endl;
  }
  //clock_t end_time = std::clock();
  //double elapsed_secs = double(end_time - begin_time) / CLOCKS_PER_SEC;
  //std::cout << "Backward Time: " << elapsed_secs << endl;
}
